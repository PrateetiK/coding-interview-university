...
- ### Arrays
    - [ ] About Arrays:
       ...
       - &check; [Arrays (video)](https://www.coursera.org/lecture/data-structures/arrays-OsBSF)
       -  [UC Berkeley CS61B - Linear and Multi-Dim Arrays (video)](https://archive.org/details/ucberkeley_webcast_Wp8oiO_CZZE) (Start watching from 15m 32s)
       - &check; [Dynamic Arrays (video)](https://www.coursera.org/lecture/data-structures/dynamic-arrays-EwbnV)
       - &check; [Jagged Arrays (video)](https://www.youtube.com/watch?v=1jtrQqYpt7g)
...
- ### Bitwise operations
    ...
    - [ ] 2s and 1s complement
        - &check; [Binary: Plusses & Minuses (Why We Use Two's Complement) (video)](https://www.youtube.com/watch?v=lKTsv6iVxV4)
